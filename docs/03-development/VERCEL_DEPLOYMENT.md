...
2. **Update Manifest URLs**
   - Replace `https://docuid-addin.vercel.app/` with your domain in `manifest-production.xml`
...
|----------|-------------|---------|
| `PRODUCTION_URL` | Custom production URL with trailing slash | `https://docuid-addin.vercel.app/` |
