    ...
    >
      ...
      >
        <a
          ...
          className="app-download-button android compact"
        >
          <svg
            fill="#fff"
          ...
          <span className="app-button-text">
            <span className="app-button-title">iVALT App</span>
            <p className="app-button-subtitle">Google Play</p>
          </span>
        </a>
        ...
        <a
          ...
          className="app-download-button ios compact"
        >
          <svg
            fill="#fff"
            className="app-icon"
          ...
          <span className="app-button-text">
            <span className="app-button-title">iVALT App</span>
            <p className="app-button-subtitle">App Store</p>
          </span>
        </a>
      </Stack>
    </Stack>
